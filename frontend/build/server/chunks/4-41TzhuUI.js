import { d as db, a as auth } from './auth-C_YzkYgM.js';
...
import { r as redirect, f as fail } from './index-CCyR2w2-.js';
...
var hasRequiredArgon2;

function requireArgon2 () {
	if (hasRequiredArgon2) return argon2;
	hasRequiredArgon2 = 1;
	const assert = require$$0$1;
	const { randomBytes, timingSafeEqual } = require$$1$1;
	const { promisify } = require$$2$1;
	const { deserialize, serialize } = requireFormat();
	const gypBuild = requireNodeGypBuild();
	...
	argon2.needsRehash = needsRehash;
...
var argon2Exports = requireArgon2();
...
const actions = {
  default: async ({ request, cookies }) => {
    ...
    try {
      ...
      const isValidPassword = await argon2Exports.verify(form.data.password, user.password);
      if (!isValidPassword) {
        form.errors.email = ["Invalid username or password."];
        return fail(400, { form });
      }
...
const index = 4;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DndC5htJ.js')).default;
...
export { SuperFormError as S, _4 as _, comparePaths as a, setPaths as b, clone as c, splitPath as d, traversePath as e, flattenErrors as f, mergePath as g, parse as h, loginSchema as l, mapErrors as m, pathExists as p, shapeFromObject as s, traversePaths as t, updateErrors as u, zodClient as z };
//# sourceMappingURL=4-41TzhuUI.js.map
