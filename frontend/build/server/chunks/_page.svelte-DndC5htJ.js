import { t as copy_payload, v as assign_payload, e as pop, w as head, p as push, x as spread_props, j as store_get, y as store_mutate, u as unsubscribe_stores, z as current_component, k as rest_props, l as fallback, m as spread_attributes, n as slot, o as bind_props, q as sanitize_props, A as element, h as escape_html } from './index3-DkBSGUoC.js';
import { z as zodClient, l as loginSchema, S as SuperFormError, s as shapeFromObject, c as clone$1, u as updateErrors, a as comparePaths, b as setPaths, d as splitPath, p as pathExists, m as mapErrors, t as traversePaths, e as traversePath, f as flattenErrors, g as mergePath, h as parse } from './4-41TzhuUI.js';
import { p as page, n as navigating, i as invalidateAll, a as applyAction } from './stores-CjN4l2Ou.js';
import { g as get, w as writable, d as derived, a as readonly } from './index2-D-UKSemM.js';
import { B as BROWSER, s as stringify } from './stringify-CNHtXLor.js';
import './index-CCyR2w2-.js';
import { c as ce, C as Card_header, a as Card_content, b as Card_title, L as Label, I as Input, d as Checkbox, B as Button, e as Logo, f as Icon } from './Logo-DCeBNQj2.js';
import { c as cn, d as default_slot } from './utils-Dl3k8kxZ.js';
import './auth-C_YzkYgM.js';
import 'pg';
import 'node:assert';
import 'node:crypto';
import 'node:util';
...
function _page($$payload, $$props) {
  ...
  var $$store_subs;
  const { data } = $$props;
  const { form, errors, constraints, enhance: enhance2 } = superForm(data.form, { validators: zodClient(loginSchema) });
  let checked = false;
  let $$settled = true;
  let $$inner_payload;
    ...
    Card_content($$payload2, {
      children: ($$payload3) => {
        ...
        Input($$payload3, spread_props([
          {
            ...
            "aria-describedby": store_get($$store_subs ??= {}, "$errors", errors).email ? "email-error email-desc" : "email-desc",
            "aria-required": store_get($$store_subs ??= {}, "$constraints", constraints).email?.required ? "true" : void 0,
            spellcheck: "false",
            get value() {
        ...
        Input($$payload3, spread_props([
          {
            ...
            "aria-invalid": store_get($$store_subs ??= {}, "$errors", errors).password ? "true" : void 0,
            "aria-describedby": store_get($$store_subs ??= {}, "$errors", errors).password ? "password-error password-desc" : "password-desc",
            "aria-required": store_get($$store_subs ??= {}, "$constraints", constraints).password?.required ? "true" : void 0,
            spellcheck: "false",
            get value() {
          ...
          Alert($$payload3, {
            ...
            children: ($$payload4) => {
              ...
              Alert_title($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out += `<!---->${escape_html(store_get($$store_subs ??= {}, "$errors", errors).email)}`;
                },
                $$slots: { default: true }
              });
              $$payload4.out += `<!---->`;
        ...
        Button($$payload3, {
          ...
          type: "submit",
          children: ($$payload4) => {
            Log_in($$payload4, { class: "mr-2 w-5" });
            $$payload4.out += `<!----> Log in`;
          },
          $$slots: { default: true }
        });
        ...
        Label($$payload3, {
          class: "font-normal",
          children: ($$payload4) => {
            $$payload4.out += `<!---->Don't have an account?`;
          },
          $$slots: { default: true }
        });
        $$payload3.out += `<!----> <a href="/register" class="text-sm cursor-pointer"><span class="text-gradient">Register!</span></a></div></form>`;
      },
      $$slots: { default: true }
    });
    $$payload2.out += `<!---->`;
...
//# sourceMappingURL=_page.svelte-DndC5htJ.js.map
