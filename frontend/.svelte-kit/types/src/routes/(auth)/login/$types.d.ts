...
type PageServerParentData = Omit<
  EnsureDefined<import("../../$types.js").LayoutServerData>,
...
type ActionsExport =
  typeof import("../../../../../../src/routes/(auth)/login/+page.server.js").actions;
  ...
  OptionalUnion<
    EnsureDefined<
      Kit.LoadProperties<
        Awaited<
          ReturnType<
            typeof import("../../../../../../src/routes/(auth)/login/+page.server.js").load
          >
        >
      >
    >
